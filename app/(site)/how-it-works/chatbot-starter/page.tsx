...
export const metadata: Metadata = {
  title: 'AI Chatbot Starter — How It Works | StrikePath',
  description: 'See exactly how the AI Chatbot Starter works, what you need to get started, and what we handle for you.',
}
...
export default function HowItWorksChatbotStarter() {
  return (
      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We build and train your chatbot within 48 hours.',
              'You get an email with an embed code and exact instructions.',
              'Paste the code on your site. Done.',
            ].map((step, i) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, paste one embed code.
            </p>
            <p style={body}>
