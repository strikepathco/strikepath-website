...
export const metadata: Metadata = {
  title: 'AI Marketing Ad Batch — How It Works | StrikePath',
  description: 'See exactly how the AI Marketing Ad Batch works, what you need to get started, and what we handle for you.',
}
...
export default function HowItWorksMarketingBasic() {
  return (
      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We generate 5–10 ads from that brief within 48 hours.',
              'You get an email with your ad creatives, ready to post on any platform.',
            ].map((step, i) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, post the ads.
            </p>
            <p style={body}>
