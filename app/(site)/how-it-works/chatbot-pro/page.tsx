...
export const metadata: Metadata = {
  title: 'AI Chatbot Pro — How It Works | StrikePath',
  description: 'See exactly how the AI Chatbot Pro works, what you need to get started, and what we handle for you.',
}
...
export default function HowItWorksChatbotPro() {
  return (
      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {[
              ...
              'Your 5 most common customer questions',
              'What tone you want (professional, friendly, or casual)',
              'Where it will live (website, Facebook, Instagram, or WhatsApp)',
              'Your business hours',
            ].map((item) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We build and train your chatbot and set up your leads dashboard within 48 hours.',
              'You get an email with your embed code, dashboard link, and exact instructions.',
              'Paste the code on your site. Bookmark your dashboard. Done.',
            ].map((step, i) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, paste one embed code, bookmark your dashboard link.
            </p>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>We do:</span> everything else.
            </p>
            <p style={{ ...body, fontStyle: 'italic', marginTop: '0.5rem' }}>
              Your leads dashboard is a live Google Sheet we set up for you. Every name, email, and phone number your chatbot collects shows up there automatically.
            </p>
          </div>
        </section>
