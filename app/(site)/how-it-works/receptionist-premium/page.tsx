      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We build your AI receptionist and set up your call log dashboard within 48 hours.',
              'You get an email with a new local phone number and your call log dashboard link.',
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, forward your existing number to the one we give you, bookmark your call log dashboard.
            </p>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>We do:</span> everything else.
            </p>
            <p style={{ ...body, fontStyle: 'italic', marginTop: '0.25rem' }}>
              Your call log dashboard is a live Google Sheet we set up for you. Every call is automatically logged with the date, caller number, reason for the call, and a full summary.
            </p>
          </div>
        </section>
