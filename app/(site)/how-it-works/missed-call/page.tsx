...
export const metadata: Metadata = {
  title: 'Missed Call Text-Back — How It Works | StrikePath',
  description: 'See exactly how the Missed Call Text-Back system works, what you need to get started, and what we handle for you.',
}
...
export default function HowItWorksMissedCall() {
  return (
      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {[
              'What you want the auto-text to say',
              'Your business hours',
              'Your phone system or provider (AT&T/Verizon, OpenPhone, RingCentral, Google Voice, or Other)',
            ].map((item) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We set up your system within 48 hours.',
              'You get an email with a new local number and one instruction: forward your existing business number to the new one we give you.',
              'Every missed call automatically texts the caller back. No action needed from you.',
            ].map((step, i) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, forward your existing number to the one we give you (takes 2 minutes in your phone settings).
            </p>
            <p style={body}>
