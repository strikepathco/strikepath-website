...
export const metadata: Metadata = {
  title: 'New Lead Alert System — How It Works | StrikePath',
  description: 'See exactly how the New Lead Alert System works, what you need to get started, and what we handle for you.',
}
...
export default function HowItWorksNewLeadAlert() {
  return (
      ...
      <div style={{ maxWidth: '42rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {[
              'The phone number you want lead alerts texted to',
              'The name to appear in the alert (your business name)',
            ].map((item) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              ...
              'We build your contact form and alert system within 48 hours.',
              'You get an email with your contact form link and instructions.',
              'Share the link or embed it on your site. Every submission instantly texts you.',
            ].map((step, i) => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <p style={body}>
              <span style={{ color: 'var(--bone)', fontWeight: 400 }}>You do:</span> fill the form, share or embed one link.
            </p>
            <p style={body}>
